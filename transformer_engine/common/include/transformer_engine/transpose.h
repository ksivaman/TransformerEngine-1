 ...
 */
__attribute__((visibility("default"))) void nvte_cast_transpose(const NVTETensor input,
 ...
 *  \param[in]     stream              CUDA stream used for the operation.
 */
__attribute__((visibility("default"))) void nvte_transpose(const NVTETensor input,
                                                           NVTETensor transposed_output,
                                                           cudaStream_t stream);
 ...
 *  \param[in]     stream              CUDA stream used for the operation.
 */
__attribute__((visibility("default"))) void nvte_cast_transpose_dbias(
    const NVTETensor input, NVTETensor cast_output, NVTETensor transposed_output, NVTETensor dbias,
 ...
 *  \param[in]     stream              CUDA stream used for the operation.
 */
__attribute__((visibility("default"))) void nvte_fp8_transpose_dbias(const NVTETensor input,
                                                                     NVTETensor transposed_output,
                                                                     NVTETensor dbias,
 ...
 *  \param[in]     stream                   CUDA stream used for the operation.
 */
__attribute__((visibility("default"))) void nvte_multi_cast_transpose(
    size_t num_tensors, const NVTETensor* input_list, NVTETensor* cast_output_list,
    NVTETensor* transposed_output_list, cudaStream_t stream);
...
__attribute__((visibility("default"))) void nvte_cast_transpose_dbias_dgelu(
    const NVTETensor input, const NVTETensor act_input, NVTETensor cast_output,
    NVTETensor transposed_output, NVTETensor dbias, NVTETensor workspace, cudaStream_t stream);

__attribute__((visibility("default"))) void nvte_cast_transpose_dbias_dsilu(
    const NVTETensor input, const NVTETensor act_input, NVTETensor cast_output,
    NVTETensor transposed_output, NVTETensor dbias, NVTETensor workspace, cudaStream_t stream);

__attribute__((visibility("default"))) void nvte_cast_transpose_dbias_drelu(
    const NVTETensor input, const NVTETensor act_input, NVTETensor cast_output,
    NVTETensor transposed_output, NVTETensor dbias, NVTETensor workspace, cudaStream_t stream);

__attribute__((visibility("default"))) void nvte_cast_transpose_dbias_dqgelu(
    const NVTETensor input, const NVTETensor act_input, NVTETensor cast_output,
    NVTETensor transposed_output, NVTETensor dbias, NVTETensor workspace, cudaStream_t stream);

__attribute__((visibility("default"))) void nvte_cast_transpose_dbias_dsrelu(
    const NVTETensor input, const NVTETensor act_input, NVTETensor cast_output,
    NVTETensor transposed_output, NVTETensor dbias, NVTETensor workspace, cudaStream_t stream);
...
__attribute__((visibility("default"))) void nvte_dgeglu_cast_transpose(const NVTETensor input,
                                                                       const NVTETensor act_input,
                                                                       NVTETensor cast_output,
                                                                       NVTETensor transposed_output,
                                                                       cudaStream_t stream);

__attribute__((visibility("default"))) void nvte_dswiglu_cast_transpose(
    const NVTETensor input, const NVTETensor act_input, NVTETensor cast_output,
    NVTETensor transposed_output, cudaStream_t stream);

__attribute__((visibility("default"))) void nvte_dreglu_cast_transpose(const NVTETensor input,
                                                                       const NVTETensor act_input,
                                                                       NVTETensor cast_output,
                                                                       NVTETensor transposed_output,
                                                                       cudaStream_t stream);

__attribute__((visibility("default"))) void nvte_dqgeglu_cast_transpose(
    const NVTETensor input, const NVTETensor act_input, NVTETensor cast_output,
    NVTETensor transposed_output, cudaStream_t stream);

__attribute__((visibility("default"))) void nvte_dsreglu_cast_transpose(
    const NVTETensor input, const NVTETensor act_input, NVTETensor cast_output,
    NVTETensor transposed_output, cudaStream_t stream);
