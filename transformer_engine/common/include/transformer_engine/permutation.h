...
__attribute__((visibility("default"))) void nvte_permute(const NVTETensor input, NVTETensor output, const NVTETensor sorted_row_id,
...
__attribute__((visibility("default"))) void nvte_unpermute(const NVTETensor input, NVTETensor output, NVTETensor row_id_map,
