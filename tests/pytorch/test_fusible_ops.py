...
class TestSequentialModules:
    ...
    def test_grouped_mlp(
        ...
        *,
        ...
        with_quantization = quantization is not None
        maybe_skip_quantization(quantization, dims=in_shape, device=device, dtype=dtype)
        if single_grouped_weight and quantization not in ("mxfp8", "nvfp4"):
            pytest.skip("single_grouped_weight is only supported for MXFP8 and NVFP4 quantization")
        ...
        if (
            ...
            if te_ops.fused.ForwardGroupedMLP_CuTeGEMMSwiGLU_BlockScaled.is_supported():
            ...
            if te_ops.fused.BackwardGroupedMLP_CuTeGEMMDSwiGLU_BlockScaled.is_supported():
    ...
    def test_grouped_mlp_single_weight_numerics(
        ...
        *,
        ...
        if not te_ops.fused.BackwardGroupedMLP_CuTeGEMMDSwiGLU_BlockScaled.is_supported():
